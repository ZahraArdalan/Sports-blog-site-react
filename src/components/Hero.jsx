    ...
    >
      ...
      <div className="flex flex-col items-start justify-center ml-16">
        <img
          src={heroText}
          alt="Hero Text"
          className="z-10 mt-20 lg:w-[500px] lg:mt-[0px]  "
        />
      </div>
      {/* mid section */}
      <div
        className="relative  flex flex-col items-center justify-center text-center lg:mt-[200px]
                  lg:ml-[-270px]"
      >
        <img
          src={basketplayer}
          alt="Basketball Player"
          className="w-[620px] h-[480px] z-20 mb-2"
        />
        <p className="text-[#262626]  leading-[25px]  mb-2 max-w-xs mt-[-100px]">
        ...
        <button
          className="w-[285px] h-[62px] mt-2 font-semibold  text-white bg-[#262626] px-2 py-2 rounded
                      "
        >
          Continue Reading
        </button>
            ...
            >
              ...
              <div
                className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t
                                   from-black/40 backdrop-blur-sm"
              ></div>
