...
const BlogDetails = () => {
  ...
  return (
    <div
      className="flex justify-center mx-4 sm:mx-8 md:mx-16 lg:mx-24 xl:mx-32
         my-8 sm:my-12 md:my-16 lg:my-20 xl:my-32"
    >
      <div className="w-full max-w-[900px]">
        {/* Title and Metadata */}
        <div className="mb-6">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#262626]">
            {news.title}
          </h2>
        ...
        <div className="prose max-w-none">
          <h4 className="text-lg sm:text-xl font-semibold my-3 sm:my-4">
            Introduction
          </h4>
        ...
        {relatedNews.length > 0 && (
          <div className="my-8 sm:my-10">
            <h3 className="text-xl sm:text-2xl font-semibold text-[#262626]">
              Related News
            </h3>
            <div
                ...
                >
                  <Link to={`/blog/${related.id}`}>
                    ...
                    <div className="p-3 sm:p-4">
                      ...
                      <span
                        className="inline-block bg-[#262626] text-xs sm:text-sm 
                                            font-semibold 
